...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tvCases, tvRecoverd, tvCritical, tvActive, tvTodayCases, tvTotalDeaths, tvTodayDeaths, tvAffectedCountries;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTodayCases = findViewById(R.id.tvTodayCaes);
    ...
    public void goTrcakCountries(View view)
    {
